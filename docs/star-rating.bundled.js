 ...
 */yt.styles=o`
  ...
  `,bt([et()],yt.prototype,"label",void 0),yt=bt([it("rating-icon")],yt);var wt=function(t,i,s,e){for(var n,o=arguments.length,r=o<3?i:null===e?e=Object.getOwnPropertyDescriptor(i,s):e,h=t.length-1;h>=0;h--)(n=t[h])&&(r=(o<3?n(r):o>3?n(i,s,r):n(i,s))||r);return o>3&&r&&Object.defineProperty(i,s,r),r};let $t=class extends Y{constructor(){super(...arguments),this.label="",this.value=0,this.max=5,this.precision=1,this.readonly=!1,this.disabled=!1,this.hoverValue=0,this.isHovering=!1,this.getSymbol=()=>'<rating-icon label="This is a rating"></rating-icon>'}getValueFromMousePosition(t){return this.getValueFromXCoordinate(t.clientX)}getValueFromXCoordinate(t){const{left:i,width:s}=this.rating.getBoundingClientRect(),e=this.roundToPrecision((t-i)/s*this.max,this.precision);return this.ensureNumberBetweenMinAndMax(e,0,this.max)}roundToPrecision(t,i=.5){const s=1/i;return Math.ceil(t*s)/s}ensureNumberBetweenMinAndMax(t,i,s){const e=t=>Object.is(t,-0)?0:t;return e(t<i?i:t>s?s:t)}handleClick(t){this.disabled||(this.setValue(this.getValueFromMousePosition(t)),this.dispatchEvent(new CustomEvent("rating-change")))}setValue(t){this.disabled||this.readonly||(this.value=t===this.value?0:t,this.isHovering=!1)}handleKeyDown(t){const i=this.value;if(!this.disabled&&!this.readonly){if("ArrowDown"===t.key||"ArrowLeft"===t.key){const i=t.shiftKey?1:this.precision;this.value=Math.max(0,this.value-i),t.preventDefault()}if("ArrowUp"===t.key||"ArrowRight"===t.key){const i=t.shiftKey?1:this.precision;this.value=Math.min(this.max,this.value+i),t.preventDefault()}"Home"===t.key&&(this.value=0,t.preventDefault()),"End"===t.key&&(this.value=this.max,t.preventDefault()),this.value!==i&&this.dispatchEvent(new CustomEvent("rating-change"))}}handleMouseEnter(t){this.isHovering=!0,this.hoverValue=this.getValueFromMousePosition(t)}handleMouseMove(t){this.hoverValue=this.getValueFromMousePosition(t)}handleMouseLeave(){this.isHovering=!1}getValueFromTouchPosition(t){return this.getValueFromXCoordinate(t.touches[0].clientX)}handleTouchStart(t){this.isHovering=!0,this.hoverValue=this.getValueFromTouchPosition(t),t.preventDefault()}handleTouchMove(t){this.hoverValue=this.getValueFromTouchPosition(t)}handleTouchEnd(t){this.isHovering=!1,this.setValue(this.hoverValue),this.dispatchEvent(new CustomEvent("rating-change")),t.preventDefault()}handleHoverValueChange(){const t=new CustomEvent("rating-hover",{detail:{phase:"move",value:this.hoverValue}});this.dispatchEvent(t)}handleIsHoveringChange(){const t=new CustomEvent("rating-hover",{detail:{phase:this.isHovering?"start":"end",value:this.hoverValue}});this.dispatchEvent(t)}focus(t){this.rating.focus(t)}blur(){this.rating.blur()}render(){const t=Array.from(Array(this.max).keys());let i=0;return i=this.disabled||this.readonly?this.value:this.isHovering?this.hoverValue:this.value,L` <div
      part="base"
